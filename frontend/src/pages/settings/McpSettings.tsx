...
import { McpConfig, BaseCodingAgent } from 'shared/types';
import { useUserSystem } from '@/components/ConfigProvider';
import { mcpServersApi } from '@/lib/api';
import { McpConfigStrategyGeneral } from '@/lib/mcpStrategies';

// Always use ClaudeCode since it's the only supported executor
const EXECUTOR = BaseCodingAgent.CLAUDE_CODE;
...
export function McpSettings() {
  ...
  // Load existing MCP configuration on mount
  useEffect(() => {
